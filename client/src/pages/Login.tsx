        ...
        <div className="gold-card rounded-3xl p-8 space-y-6">
          <div className="text-center space-y-2">
            ...
            <p className="text-xs text-zinc-500">
              Enter your behavioral intelligence credentials.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-black/40 border border-white/5 rounded-xl text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-yellow-500/30 transition font-mono animate-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link to="/forgot-password" className="text-[10px] text-yellow-500 hover:text-white transition">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 bg-black/40 border border-white/5 rounded-xl text-xs text-white placeholder-zinc-500 focus:outline-none focus:border-yellow-500/30 transition font-mono animate-all"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              <label className="flex items-center gap-2 cursor-pointer select-none text-zinc-400">
                <input
                  ...
                  className="rounded border-white/10 bg-black/40 text-yellow-500 focus:ring-0"
                />
          ...
          <div className="space-y-3 pt-2">
            <div className="flex items-center gap-2 text-[10px] text-zinc-500 uppercase tracking-widest font-semibold justify-center">
              ...
              <span>Or link credentials via</span>
              <div className="h-[1px] w-12 bg-white/5" />
            </div>
          ...
          <div className="text-center text-xs text-zinc-500 pt-2">
            No terminal profile?{" "}
            <Link to="/signup" className="text-yellow-500 hover:text-white transition font-medium">
              Create Profile
            </Link>
          </div>
        </div>
